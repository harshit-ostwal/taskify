...
function page() {
  return (
    <div className="flex items-center justify-center w-full py-20">
      <div className="flex flex-col w-11/12 h-full gap-20 lg:max-w-4xl">
          ...
          <div className="flex items-center justify-between gap-4 py-4">
            <div className="flex items-center gap-4">
              <div className="p-2 bg-purple-100 rounded-lg">
                <Icons.bell className="w-5 h-5 text-purple-600" />
              </div>
              <div>
            ...
            {[
              ...
              <div key={index} className="flex items-start gap-4 p-4 rounded-lg bg-gray-50">
                <div className={`p-2 rounded-lg ${notification.type === 'security' ? 'bg-red-100' : 'bg-blue-100'
                  ...
                  <Icons.bell className={`w-5 h-5 ${notification.type === 'security' ? 'text-red-600' : 'text-blue-600'
                    }`} />
                </div>
